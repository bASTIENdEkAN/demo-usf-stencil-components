...
if(input){
    ...
    let phoneCountryIso = input.getAttribute('data-init-country');
    ...
    form.addEventListener("submit", (event) => {
        const countryCodeInput = document.querySelector('#intl-tel-input-country-code');
        const fullNumberLessInput = document.querySelector('#intl-tel-input-full-number-less');
        const getCode = iti.getSelectedCountryData();
