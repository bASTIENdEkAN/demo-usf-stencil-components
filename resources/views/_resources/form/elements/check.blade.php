@if($check == 1)
{{-- check #01 --}}
<svg class="check-svg check-svg--1" width="14" height="12" viewBox="0 0 14 9" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@elseif($check == 2)
{{-- check #02 --}}
<svg class="check-svg check-svg--2" width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@elseif($check == 3)
{{-- check #03 --}}
<svg class="check-svg check-svg--3" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
